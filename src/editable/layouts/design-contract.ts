...
export const editableRootStyle = {
  ...
  '--slot4-page-text': '#161E54',
  '--slot4-panel-bg': '#eef8fc',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#4b5682',
  '--slot4-soft-muted-text': '#999999',
  '--slot4-accent': '#161E54',
  '--slot4-accent-fill': '#161E54',
  '--slot4-accent-soft': '#BBE0EF',
  ...
  '--editable-border': '#e5e7ee',
  '--editable-nav-bg': '#ffffff',
  '--editable-nav-text': '#1a1a1a',
  '--editable-nav-active': '#161E54',
  '--editable-nav-active-text': '#ffffff',
  '--editable-cta-bg': '#161E54',
